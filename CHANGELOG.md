...
- chore: update docker-compose.prod.yml to use versioned image
- fix: add missing permissions to docker workflow jobs and fix YAML syntax
- fix: enable docker build workflow for GHCR
- Release v0.7.2-cs2
...
### Docker Images
- `ghcr.io/codingsoft/open-webui:0.7.2-cs3,`
- `ghcr.io/codingsoft/open-webui:0.7.2-cs3,-slim`
- `ghcr.io/codingsoft/open-webui:0.7.2-cs3,-cuda`
- `ghcr.io/codingsoft/open-webui:0.7.2-cs3,-ollama`
