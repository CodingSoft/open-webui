...
class MilvusClient(VectorDBBase):
    ...
    def _get_collection_and_resource_id(self, collection_name: str) -> Tuple[str, str]:
        ...
        WARNING: This mapping relies on current CodingSoft Open WebUI naming conventions for
        collection names. If CodingSoft Open WebUI changes how it generates collection names
