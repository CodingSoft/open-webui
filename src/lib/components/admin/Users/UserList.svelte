...
> 
> - 👉 **[Click here to learn more about enterprise licensing](https://docs.webui.codingsoft.org/enterprise)**
> - 👉 *[Click here to sponsor the project](https://github.com/sponsors/codingsoft)*
`}
			/>
		</div>
	{/if}
